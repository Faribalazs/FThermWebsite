        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100 mb-4 sm:mb-6">
            <div class="bg-gradient-to-r from-primary-600 to-primary-700 px-4 sm:px-8 py-5 sm:py-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg sm:text-2xl font-bold text-white">Izmeni Skladište</h1>
                        <p class="text-primary-100 text-xs sm:text-sm mt-0.5">{{ $warehouse->name }}</p>
                    </div>
                </div>
            </div>
                    ...
                    @if($warehouse->inventories()->count() > 0)
                        <div class="mb-5 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-blue-900">{{ $warehouse->inventories()->count() }} artikala u zalihama</p>
                                    <p class="text-xs text-blue-700 mt-0.5">Ne možete obrisati skladište koje ima zalihe.</p>
                                </div>
                            </div>
                        </div>
                    @endif
