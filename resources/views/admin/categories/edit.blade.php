...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Izmeni kategoriju</h2>
        ...
        <form action="{{ route('admin.product-categories.update', $category) }}" method="POST">
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <input type="text" id="name_en" name="name_en" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('name_en', $category->name['en'] ?? '') }}">
                    @error('name_en')
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <input type="text" id="name_sr" name="name_sr" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('name_sr', $category->name['sr'] ?? '') }}">
                    @error('name_sr')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <input type="text" id="name_hu" name="name_hu" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('name_hu', $category->name['hu'] ?? '') }}">
                    @error('name_hu')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('slug', $category->slug) }}">
                        @error('slug')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="active" name="active" class="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500" {{ old('active', $category->active) ? 'checked' : '' }}>
