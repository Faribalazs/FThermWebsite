...
<div class="animate-fade-in-up">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Kreiraj kategoriju</h1>
                <p class="text-xs sm:text-sm text-gray-500 mt-0.5">Dodajte novu kategoriju proizvoda</p>
            </div>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="slug" name="slug" required class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('slug') }}" placeholder="klima-uredjaji">
                        </div>
