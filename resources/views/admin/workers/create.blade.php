...
<div class="animate-fade-in-up">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Dodaj Radnika</h1>
                <p class="text-xs sm:text-sm text-gray-500 mt-0.5">Kreirajte novi nalog za zaposlenog</p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="px-4 sm:px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-sm sm:text-base font-bold text-gray-900">Osnovne informacije</h3>
                    </div>
                </div>
                <div class="p-4 sm:p-6">
                    <div class="grid gap-4 sm:gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" required
                                    ...
                                    placeholder="npr. Marko Marković" value="{{ old('name') }}">
                            </div>
                            @error('name')
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" required
                                    class="w-full pl-10 pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all text-sm shadow-sm bg-gray-50 focus:bg-white placeholder-gray-400"
                                    placeholder="marko@ftherm.com" value="{{ old('email') }}">
                            </div>
                            @error('email')
                                <p class="mt-1.5 text-xs text-red-600 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-xs sm:text-sm font-bold text-gray-700 mb-1.5">Lozinka <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-xs sm:text-sm font-bold text-gray-700 mb-1.5">Potvrdi lozinku <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
