...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Dodaj novog radnika</h1>
            <p class="mt-2 text-sm text-gray-500">Kreirajte novi nalog za zaposlenog sa pristupom sistemu.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        <div class="p-8">
            <form action="{{ route('admin.workers.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center space-x-4 mb-6">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Osnovne Informacije</h3>
                            <p class="text-sm text-gray-500">Unesite lične podatke i pristupne parametre.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-sm font-semibold text-gray-700 mb-2">Lozinka <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-semibold text-gray-700 mb-2">Potvrdi Lozinku <span class="text-red-500">*</span></label>
