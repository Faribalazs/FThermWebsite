...
<div class="animate-fade-in-up">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Kreiraj novi proizvod</h1>
                <p class="text-xs sm:text-sm text-gray-500 mt-0.5">Dodajte novi proizvod na sajt</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-4 sm:mb-6" x-data="{ langTab: 'sr' }">
            ...
            <div x-show="langTab === 'sr'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="p-4 sm:p-6 space-y-4">
                <div>
                    ...
                    <input type="text" id="name_sr" name="name_sr" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('name_sr') }}">
                ...
                <div>
                    ...
                    <textarea id="description_sr" name="description_sr" rows="4" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">{{ old('description_sr') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="technical_specs_sr" name="technical_specs_sr" rows="4" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">{{ old('technical_specs_sr') }}</textarea>
            ...
            <div x-show="langTab === 'en'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="p-4 sm:p-6 space-y-4">
                <div>
                    ...
                    <input type="text" id="name_en" name="name_en" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('name_en') }}">
                ...
                <div>
                    ...
                    <textarea id="description_en" name="description_en" rows="4" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">{{ old('description_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="technical_specs_en" name="technical_specs_en" rows="4" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">{{ old('technical_specs_en') }}</textarea>
            ...
            <div x-show="langTab === 'hu'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="p-4 sm:p-6 space-y-4">
                <div>
                    ...
                    <input type="text" id="name_hu" name="name_hu" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('name_hu') }}">
                ...
                <div>
                    ...
                    <textarea id="description_hu" name="description_hu" rows="4" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">{{ old('description_hu') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="technical_specs_hu" name="technical_specs_hu" rows="4" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">{{ old('technical_specs_hu') }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="slug" name="slug" required class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('slug') }}" placeholder="klima-uredjaj-model-x">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" id="price" name="price" class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('price') }}">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="order" name="order" required class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white" value="{{ old('order', 0) }}">
                        </div>
                    ...
                    <div class="flex items-end">
                        <label class="relative inline-flex items-center gap-3 cursor-pointer group p-3 rounded-xl border border-gray-200 bg-gray-50 hover:bg-white transition-all duration-200 w-full has-[:checked]:border-green-200 has-[:checked]:bg-green-50">
                            <input type="checkbox" id="active" name="active" class="sr-only peer" {{ old('active', true) ? 'checked' : '' }}>
