...
<div class="animate-fade-in-up">
    ...
    <form action="{{ route('admin.services.update', $service) }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6">
            <div class="bg-gradient-to-r from-primary-600 to-primary-700 px-4 sm:px-6 py-4 sm:py-5">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg sm:text-xl font-bold text-white">Izmeni uslugu</h1>
                        <p class="text-primary-100 text-xs sm:text-sm mt-0.5">{{ $service->title['sr'] ?? $service->title['en'] ?? '' }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div x-show="langTab === 'sr'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform translate-y-1" x-transition:enter-end="opacity-100 transform translate-y-0">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="title_sr" name="title_sr" required value="{{ old('title_sr', $service->title['sr'] ?? '') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="Unesite naziv usluge">
                        ...
                        <div>
                            ...
                            <textarea id="description_sr" name="description_sr" rows="6" required class="tinymce-editor w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="Unesite opis usluge">{{ old('description_sr', $service->description['sr'] ?? '') }}</textarea>
                ...
                <div x-show="langTab === 'en'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform translate-y-1" x-transition:enter-end="opacity-100 transform translate-y-0">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="title_en" name="title_en" required value="{{ old('title_en', $service->title['en'] ?? '') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="Enter service title">
                        ...
                        <div>
                            ...
                            <textarea id="description_en" name="description_en" rows="6" required class="tinymce-editor w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="Enter service description">{{ old('description_en', $service->description['en'] ?? '') }}</textarea>
                ...
                <div x-show="langTab === 'hu'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform translate-y-1" x-transition:enter-end="opacity-100 transform translate-y-0">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="title_hu" name="title_hu" required value="{{ old('title_hu', $service->title['hu'] ?? '') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="Adja meg a szolgáltatás nevét">
                        ...
                        <div>
                            ...
                            <textarea id="description_hu" name="description_hu" rows="6" required class="tinymce-editor w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="Adja meg a szolgáltatás leírását">{{ old('description_hu', $service->description['hu'] ?? '') }}</textarea>
        ...
        <!-- Icon Card -->
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6" x-data="{ svgContent: {{ json_encode(old('icon', $service->icon ?? '')) }} }">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    <div class="flex-1">
                        ...
                        <textarea id="icon" name="icon" rows="5" x-model="svgContent"
                            ...
                            placeholder='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M13 10V3L4 14h7v7l9-11h-7z"/>'>{{ old('icon', $service->icon ?? '') }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="order" name="order" required value="{{ old('order', $service->order) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" placeholder="0">
                        </div>
