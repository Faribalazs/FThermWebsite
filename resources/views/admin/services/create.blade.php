...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Create New Service</h2>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="title_en" name="title_en" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('title_en') }}">
                        @error('title_en')
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="title_sr" name="title_sr" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('title_sr') }}">
                        @error('title_sr')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="title_hu" name="title_hu" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value="{{ old('title_hu') }}">
                        @error('title_hu')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="icon" name="icon" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" placeholder="🔥 or SVG" value="{{ old('icon') }}">
                        @error('icon')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
