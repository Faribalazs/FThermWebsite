    ...
    <div class="min-h-screen flex">
        ...
        <aside id="sidebar" class="w-64 bg-industrial-900 text-white flex-shrink-0 fixed h-screen overflow-y-auto custom-scrollbar z-50 flex flex-col transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
            ...
            <nav class="mt-4 lg:mt-6 sidebar-nav flex-1">
                ...
                <a href="{{ route('worker.contacts.index') }}" class="flex items-center px-4 lg:px-6 py-3 text-gray-300 hover:bg-industrial-800 hover:text-white transition-all {{ request()->routeIs('worker.contacts.*') ? 'bg-industrial-800 text-white border-l-4 border-primary-500 active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    <span class="text-sm lg:text-base">Kontakti</span>
                </a>
            </nav>
                ...
                <div class="absolute inset-x-0 bottom-0 bg-white rounded-t-3xl shadow-2xl transform translate-y-full transition-transform duration-300" id="mobile-more-menu-content">
                    ...
                    <div class="px-4 py-2 pb-8">
                        ...
                        <div class="space-y-1 max-h-96 overflow-y-auto">
                            ...
                            <!-- Contacts -->
                            <a href="{{ route('worker.contacts.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 transition-colors {{ request()->routeIs('worker.contacts.*') ? 'bg-primary-50 text-primary-600' : 'text-gray-700' }}">
                                <div class="w-10 h-10 rounded-full {{ request()->routeIs('worker.contacts.*') ? 'bg-primary-100' : 'bg-gray-100' }} flex items-center justify-center">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                    </svg>
                                </div>
                                <span class="font-medium">Kontakti</span>
                            </a>
